...
2. There are multiple options for the Filamentalist.  Determine which versions/options you want and select the stl's to print accordingly.
   - Unit Width: 80mm, 100mm, and custom width via Fusion 360 parametric model
     -  80mm - Designed around 80mm long off-the-shelf 8mm axles.  This standard version maximizes space efficiency with common spool size compatibility, accomodating spool widths up to 68mm.  Total rewinder width is 81.5mm allowing 6 units across the top of a 350 Voron mounted on 500mm extrusions.
     -  100mm - Designed around 100mm long off-the-shelf 8mm axles.  This size accomodates spool widths up to 86.5mm (basically all brands of 1kg spools).  Total rewinder width is 100mm.
     -  Parametric Model - If you use Autodesk Fusion 360 you can adjust the design for virtually any realistic spool width and axle size.  You can also "push" the design a bit using an acceptable axle "underhang" to get more spool width.  For example you can effectively accomodate a spool width of 72mm (KVP, NinjaFlex) on the 80mm axle with an underhang value of -2.75mm.  With this underhang the axle is still fully captured by the 608 bearings.  You could even push this further to an underhang of -5.75mm to get a max spool width of 78mm and still have acceptable axle engagement with the 608 bearings.
